...
-- AlterTable
ALTER TABLE "PathMatesGroup" ADD COLUMN     "description" TEXT,
...
-- AddForeignKey
ALTER TABLE "GroupMember" ADD CONSTRAINT "GroupMember_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "PathMatesGroup"("id") ON DELETE CASCADE ON UPDATE CASCADE;
