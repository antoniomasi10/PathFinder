...
const CATEGORY_FEEDS: Array<{ url: string; forcedType: OpportunityType | null }> = [
  ...
  { url: `${BASE_URL}/category/conferences/feed/?posts_per_page=50`,    forcedType: 'EVENT'        },
  { url: `${BASE_URL}/category/internships/feed/?posts_per_page=50`,    forcedType: 'TIROCINIO'    },
