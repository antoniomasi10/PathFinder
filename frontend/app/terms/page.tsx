  ...
  return (
    <div className="min-h-screen bg-white text-gray-800">
      <div className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-bold mb-2 text-gray-900">Termini di Servizio</h1>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-3 text-gray-900">4. Account e Sicurezza</h2>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm text-gray-700">
            ...
            <li>Molestare, minacciare o perseguitare altri utenti</li>
            <li>Diffondere spam, messaggi pubblicitari non richiesti o phishing</li>
            ...
            <li>Utilizzare sistemi automatizzati (bot, scraper) senza previa autorizzazione scritta</li>
            <li>Interferire con il funzionamento della piattaforma</li>
          </ul>
        </section>

        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-3 text-gray-900">7. Sospensione e Cancellazione</h2>
          <p className="text-sm leading-relaxed text-gray-700">
            Ci riserviamo il diritto di sospendere o cancellare il tuo account, senza preavviso, in caso di
            violazione dei presenti Termini. Puoi cancellare il tuo account in qualsiasi momento dalle
            impostazioni del profilo. Alla cancellazione, i tuoi dati saranno eliminati secondo quanto
            previsto nell&apos;Informativa sulla Privacy.
          </p>
        </section>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-3 text-gray-900">11. Contatti</h2>
          <p className="text-sm leading-relaxed text-gray-700">
            Per qualsiasi domanda sui presenti Termini: <strong>[EMAIL LEGALE]</strong>
          </p>
        </section>
      </div>
    </div>
