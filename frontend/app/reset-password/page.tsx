        ...
        <div className="relative bg-[rgba(206,205,205,0.12)] border border-[rgba(0,0,0,0.33)] rounded-[1.5rem] shadow-[2px_2px_14.7px_1px_rgba(0,0,0,0.25)] px-6 pt-16 pb-7 flex flex-col items-center">
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-[0.625rem] mt-1 mb-4">
              ...
              {/* Codice */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-[#2c3149] tracking-[0.03125rem]">{t.security.verificationCode}</label>
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none">
                    <CodeIcon />
                  </span>
                  <input
                    ...
                    maxLength={6}
                    required
                    className="w-full bg-[#fbf8ff] border border-[#acb0ce] rounded-[1.5rem] pl-[2.8125rem] pr-4 py-4 text-sm text-[#2c3149] placeholder:text-[#747995] focus:outline-none focus:ring-2 focus:ring-[#615fe2]/30 focus:border-[#615fe2] transition-all text-center tracking-[0.4em]"
                  />
                </div>
              </div>
              ...
              {/* Nuova password */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-[#2c3149] tracking-[0.03125rem]">{t.security.newPassword}</label>
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none">
                    <LockIcon />
                  </span>
              ...
              {/* Conferma password */}
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium text-[#2c3149] tracking-[0.03125rem]">{t.security.confirmPassword}</label>
                <div className="relative">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none">
                    <LockIcon />
                  </span>
