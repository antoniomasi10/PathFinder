...
export default function EditProfilePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#fbf8ff' }}>
        ...
        <div className="max-w-lg mx-auto flex items-center justify-between h-full px-4 relative">
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <svg width="129" height="37" viewBox="0 0 129 37" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="COhA">
              ...
              <mask id="mask0_edit" style={{maskType:'alpha'}} maskUnits="userSpaceOnUse" x="35" y="0" width="63" height="37">
                <path d="M71.4712 25.1531C70.7006 23.029 70.2645 21.7405 69.7296 19.7567C69.4798 20.0067 69.2177 20.2587 68.9286 20.5282L69.9375 25.1531L71.2156 31.1483C71.7336 33.6313 72.0648 34.9232 73.1752 36.9722H79.1393C76.8634 34.9814 75.5636 33.7184 74.1976 31.1483C73.1431 29.2076 72.518 27.9747 71.8426 26.1809C71.7213 25.8588 71.5985 25.5187 71.4712 25.1531Z" fill="#615FE2"/>
              ...
              <g mask="url(#mask0_edit)">
                <rect x="21.1184" y="8.70459" width="46.8622" height="28.2899" fill="url(#edit_g0)"/>
                <rect x="69.215" y="18.6378" width="49.7354" height="29.6082" fill="url(#edit_g1)"/>
                <rect x="64.48" y="23.0285" width="17.4359" height="37.5037" fill="url(#edit_g2)"/>
                <rect x="65.8629" y="-9.88831" width="25.4121" height="27.3988" fill="url(#edit_g3)" fillOpacity="0.75"/>
              </g>
              ...
              <defs>
                <linearGradient id="edit_g0" x1="90.8031" y1="24.4817" x2="17.1625" y2="24.4817" gradientUnits="userSpaceOnUse">
                  <stop offset="0.240385" stopColor="#615FE2" stopOpacity="0.52"/>
                  <stop offset="0.602697" stopColor="#FBF8FF"/>
                </linearGradient>
                <linearGradient id="edit_g1" x1="143.172" y1="35.1501" x2="65.0165" y2="35.1501" gradientUnits="userSpaceOnUse">
                  <stop offset="0.649865" stopColor="#FBF8FF"/>
                  <stop offset="0.941702" stopColor="#615FE2" stopOpacity="0.52"/>
                </linearGradient>
                <linearGradient id="edit_g2" x1="73.0335" y1="20.1116" x2="73.2974" y2="60.5316" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#615FE2" stopOpacity="0.46"/>
                  <stop offset="0.447379" stopColor="#FBF8FF" stopOpacity="0.49"/>
                </linearGradient>
                <linearGradient id="edit_g3" x1="87.6447" y1="-10.9698" x2="66.1891" y2="12.2683" gradientUnits="userSpaceOnUse">
          ...
          <button
            onClick={() => router.back()}
            className="flex items-center justify-center active:opacity-75 z-10"
      ...
      {loading ? (
        <div className="flex-1 px-6 pt-6 space-y-5 animate-pulse">
          <div className="flex flex-col items-center gap-3">
            <div className="w-24 h-24 rounded-full bg-[#e2e4f0]" />
          </div>
          <div className="h-12 rounded-xl bg-[#e2e4f0]" />
          <div className="h-12 rounded-xl bg-[#e2e4f0]" />
          <div className="h-24 rounded-xl bg-[#e2e4f0]" />
          <div className="h-12 rounded-xl bg-[#e2e4f0]" />
        </div>
      ) : (
        <main className="flex-1 flex flex-col px-6 pt-6 pb-32">
          <h1
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col items-center">
              ...
              >
                <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#615fe2] to-[#7073ff] flex items-center justify-center text-2xl font-bold text-white overflow-hidden">
                  {displayAvatar && isValidImageUrl(displayAvatar) ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-[rgba(172,176,206,0.3)] rounded-xl px-4 py-3 text-sm text-[#2c3149] placeholder-[#acb0ce] focus:outline-none focus:border-[#615fe2] transition-colors"
                />
              </div>
              <div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <span className={`text-xs ${bio.length > 480 ? 'text-red-400' : 'text-[#acb0ce]'}`}>{bio.length}/500</span>
              </div>
              <textarea
                value={bio}
                ...
                className="w-full bg-white border border-[rgba(172,176,206,0.3)] rounded-xl px-4 py-3 text-sm text-[#2c3149] placeholder-[#acb0ce] focus:outline-none focus:border-[#615fe2] transition-colors resize-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (!e.target.value) { setYear(undefined); return; }
                  if (Number.isInteger(v) && v >= 1 && v <= 5) setYear(v);
                }}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {skills.map((key) => (
                  <span
                    key={key}
                    className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium bg-[#615fe2] text-white"
                  >
                    {getSkillLabel(key, t)}
                  </span>
                ))}
          ...
          {error && (
            <div className="mt-4 bg-red-50 text-red-500 rounded-xl px-4 py-3 text-sm">
              {error}
            </div>
          )}
