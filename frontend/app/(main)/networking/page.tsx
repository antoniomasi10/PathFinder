      ...
      {!selectedUser && !selectedGroup && (
        <div>
          ...
          {(searchQuery.trim() || hasProfileFilters(selectedClusterTag, profileYearFilter, coreSkillArea)) ? (
            ...
            <>
              {/* ── PERSONE SUGGERITE ─────────────────────────────── */}
              <div style={{ paddingTop: 16, paddingBottom: 20, position: 'relative' }}>
                ...
                {suggestionsLoading ? (
                  ...
                  <div className="scrollbar-hide" style={{ display: 'flex', gap: 12, overflowX: 'auto', paddingLeft: 16, paddingRight: 16, paddingBottom: 20 }}>
                    {(() => {
                ...
                {/* Bottom fade to mask card shadow cutoff */}
                <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 28, background: 'linear-gradient(to bottom, rgba(251,248,255,0), #fbf8ff)', pointerEvents: 'none' }} />
              </div>
