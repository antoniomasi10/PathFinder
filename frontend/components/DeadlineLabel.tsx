...
export function OpenLabel({ size = 'sm' }: { size?: 'sm' | 'xs' }) {
  return (
    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full font-medium ${size === 'xs' ? 'text-[0.625rem]' : 'text-xs'}`}
      style={{ backgroundColor: '#f0f0f9', color: '#6b6f8a' }}>
